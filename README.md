...
VPS
-------
1. I recommend using a Ubuntu 18.04 LTS from DigitalOcean, Repl.it, Goormide
2. Run `sudo apt install git` command
3. Run `git clone https://github.com/Elvar1/FB-Bots-by-Aftoaxs.git` command
4. Run `cd FB-Bots-by-Aftoaxs` command
